...
<Project Type="Project" LVVersion="11008008">
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="Vision Support Code" Type="Folder">
			<Item Name="Compute Distance.vi" Type="VI" URL="../Vision Support VIs/Compute Distance.vi"/>
			<Item Name="Score Particles.vi" Type="VI" URL="../Vision Support VIs/Score Particles Folder/Score Particles.vi"/>
			<Item Name="Draw Filled Rect.vi" Type="VI" URL="../Vision Support VIs/Draw Filled Rect Folder/Draw Filled Rect.vi"/>
			<Item Name="FindColoredObject.vi" Type="VI" URL="../Vision Support VIs/FindColoredObject Folder/FindColoredObject.vi"/>
			<Item Name="Servo Tracking State Machine.vi" Type="VI" URL="../Vision Support VIs/Servo Tracking State Machine Folder/Servo Tracking State Machine.vi"/>
			<Item Name="RT Overlay Helper.vi" Type="VI" URL="../Vision Support VIs/RT Overlay Helper Folder/RT Overlay Helper.vi"/>
			<Item Name="2012 Target Simulator.vi" Type="VI" URL="../2012 Target Simulator.vi"/>
		</Item>
		...
		<Item Name="Vision Tracking.vi" Type="VI" URL="../Vision Tracking.vi"/>
		...
		<Item Name="Dependencies" Type="Dependencies">
			...
			<Item Name="Sorted Particle Report.vi" Type="VI" URL="../Vision Support VIs/Score Particles Folder/Sorted Particle Report.vi"/>
			<Item Name="Aspect Ratio Score.vi" Type="VI" URL="../Vision Support VIs/Score Particles Folder/Aspect Ratio Score.vi"/>
			<Item Name="Rectangularity Score.vi" Type="VI" URL="../Vision Support VIs/Score Particles Folder/Rectangularity Score.vi"/>
			<Item Name="Normalized Range Compare.vi" Type="VI" URL="../Vision Support VIs/Score Particles Folder/Normalized Range Compare.vi"/>
			<Item Name="SizeOrderedMorphology.vi" Type="VI" URL="../Vision Support VIs/FindColoredObject Folder/SizeOrderedMorphology.vi"/>
			<Item Name="Control States.ctl" Type="VI" URL="../Vision Support VIs/Servo Tracking State Machine Folder/Control States.ctl"/>
			<Item Name="Center of Rect.vi" Type="VI" URL="../Vision Support VIs/Servo Tracking State Machine Folder/Center of Rect.vi"/>
			<Item Name="Deadband.vi" Type="VI" URL="../Vision Support VIs/Servo Tracking State Machine Folder/Deadband.vi"/>
		</Item>
		<Item Name="Build Specifications" Type="Build">
			<Item Name="FRC PC Dashboard" Type="EXE">
				...
				<Property Name="Source[0].itemID" Type="Str">{80A85BF7-C3A7-402D-9CF2-52223911C37F}</Property>
